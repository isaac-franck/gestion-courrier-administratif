        ...
        <section class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-700 via-green-600 to-emerald-500 p-6 text-white shadow-xl sm:p-8">
            ...
            <div class="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white/15 text-2xl font-bold backdrop-blur">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-green-100">
                            {{ $service->users()->count() }} utilisateur(s) affecté(s)
                        </p>
                ...
                @if($service->actif)
                    ...
                    <span class="inline-flex w-fit items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-sm font-semibold backdrop-blur">
                ...
                @else
                    ...
                    <span class="inline-flex w-fit items-center gap-2 rounded-full bg-black/10 px-4 py-2 text-sm font-semibold backdrop-blur">
            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="border-b border-slate-100 pb-6 dark:border-slate-800">
                    ...
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Modifiez les informations nécessaires puis
                ...
                <div class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            maxlength="255"
                            class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-green-500 focus:ring-4 focus:ring-green-500/10 dark:border-slate-700 dark:bg-slate-950">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="5"
                            maxlength="1000"
                            class="w-full resize-none rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-green-500 focus:ring-4 focus:ring-green-500/10 dark:border-slate-700 dark:bg-slate-950">{{ old('description', $service->description) }}</textarea>
                    ...
                    <div class="rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                    Un service inactif ne pourra pas être
                                    utilisé pour de nouvelles affectations.
                                </p>
                            ...
                            @if($service->actif)
                                ...
                                <span class="shrink-0 rounded-full bg-green-100 px-3 py-1.5 text-xs font-semibold text-green-700 dark:bg-green-950/50 dark:text-green-400">
                                    Actif
                                </span>

                            @else

                                <span class="shrink-0 rounded-full bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-600 dark:bg-slate-800 dark:text-slate-400">
                                    Inactif
                                </span>
                    ...
                    <div class="rounded-2xl border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-900/40 dark:bg-yellow-950/20">
                        ...
                        <div class="flex gap-3">
                            ...
                            <p class="text-sm leading-6 text-yellow-800 dark:text-yellow-300">
                                La modification du service ne modifie pas
                                automatiquement le statut des utilisateurs
